...
{
	blogPosts.map(post=>(
		<div className=" flex flex-col border-b gap-5 w-full items-center justify-between" key={post.id}>
			...
			<div className="flex my-2">
				<p className="font-thin font-noto text-xs md:text-base sm:truncate">{post.summary}</p>
			</div>

				
			</div>
			<div className="flex cursor-pointer items-center justify-center w-20 lg:w-40" title="Post Icon"> 
				...
				<div className="date cursor-pointer flex flex-row items-center justify-between gap-1 text-xs font-thin">
				...
				<div className="flex flex-row gap-7 my-2"> 
					...
					<div className="cursor-pointer ">
						{/*save SVG button*/}
						<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" class="cc"><path fill="#000" d="M17.5 1.25a.5.5 0 0 1 1 0v2.5H21a.5.5 0 0 1 0 1h-2.5v2.5a.5.5 0 0 1-1 0v-2.5H15a.5.5 0 0 1 0-1h2.5zm-11 4.5a1 1 0 0 1 1-1H11a.5.5 0 0 0 0-1H7.5a2 2 0 0 0-2 2v14a.5.5 0 0 0 .8.4l5.7-4.4 5.7 4.4a.5.5 0 0 0 .8-.4v-8.5a.5.5 0 0 0-1 0v7.48l-5.2-4a.5.5 0 0 0-.6 0l-5.2 4z"></path></svg>
					</div>
